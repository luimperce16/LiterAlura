    ...
    public void consumo() {
        ...
        while (opcion != 0) {
            var menu = String.format("""
                    ...
                    %s
                    %s|***************************************************|%s
                    %s|*****            INGRESE UNA OPCIÓN          ******|%s
                    %s|***************************************************|%s
                    """,
                    ANSI_CYAN, ANSI_RESET, ANSI_GREEN, ANSI_RESET, ANSI_CYAN, ANSI_RESET,
                    ANSI_YELLOW, ANSI_YELLOW, ANSI_RESET,
                    ANSI_CYAN, ANSI_RESET, ANSI_CYAN, ANSI_RESET, ANSI_CYAN, ANSI_RESET);

            try {
                System.out.println(menu);
                System.out.print(ANSI_BLUE + "Tu opción: " + ANSI_RESET);
                opcion = sc.nextInt();
                sc.nextLine();
